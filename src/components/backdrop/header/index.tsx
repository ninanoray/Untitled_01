...
const Header = ({ page }: Props) => {
  return (
    <header className="flex h-16 shrink-0 items-center gap-2 bg-slate-50 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 select-none">
